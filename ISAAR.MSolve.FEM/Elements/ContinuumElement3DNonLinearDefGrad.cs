    ...
    public class ContinuumElement3DNonLinearDefGrad : IStructuralFiniteElement//, IEmbeddedHostElement
    {
        ...
        private double[] UpdateForces(IElement element)
        {
            ...
            for (int npoint = 0; npoint < nGaussPoints; npoint++)
            {
                ...
                var secondPiolaElastic = new double[3, 3] { {stressesElastic[0],stressesElastic[3],stressesElastic[4] },
                    { stressesElastic[3],stressesElastic[1],stressesElastic[5] },
                    {stressesElastic[4],stressesElastic[5],stressesElastic[2] } };
                ...
                double[,] defGradInverseTransposed = new double[3, 3] { { defGradTransposed[2, 2]*defGradTransposed[1,1]- defGradTransposed[2, 1]
                    * defGradTransposed[1, 2],-(defGradTransposed[2, 2] * defGradTransposed[0, 1] - defGradTransposed[2, 1]
                    * defGradTransposed[0, 2]), defGradTransposed[1,2] * defGradTransposed[0, 1] - defGradTransposed[1, 1] * defGradTransposed[0, 2] },
                    { -(defGradTransposed[2,2]*defGradTransposed[1,0]-defGradTransposed[2,0]*defGradTransposed[1,2]),defGradTransposed[2,2]
                    *defGradTransposed[0,0]-defGradTransposed[2,0]*defGradTransposed[0,2], -(defGradTransposed[1,2]*defGradTransposed[0,0]-defGradTransposed[1,0]
                    *defGradTransposed[0,2]) }, {defGradTransposed[2,1]*defGradTransposed[1,0]-defGradTransposed[2,0]*defGradTransposed[1,1],-(defGradTransposed[2,1]
                    *defGradTransposed[0,0]-defGradTransposed[2,0]*defGradTransposed[0,1]),defGradTransposed[1,1]*defGradTransposed[0,0]-defGradTransposed[1,0]
                    *defGradTransposed[0,1] } };
                ...
                var stresses = new double[6] { secondPiola[0, 0], secondPiola[1, 1], secondPiola[2, 2], secondPiola[0, 1], secondPiola[1, 2], secondPiola[2, 1] };
