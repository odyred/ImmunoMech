...
df = pd.read_excel (r'C:\Users\Ody\source\repos\EKite\EKite\Data\tzeranisDataControlNoLabels0ForNan.xlsx', header=None) 
...
mydmap = dm.DiffusionMap.from_sklearn(n_evecs=2, k=1, epsilon='bgh', alpha=0.5, neighbor_params=neighbor_params)
# fit to data and return the diffusion map.
dmap = mydmap.fit_transform(X_scaled)
