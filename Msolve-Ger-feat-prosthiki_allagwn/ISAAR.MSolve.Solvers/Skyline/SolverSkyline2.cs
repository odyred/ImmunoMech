...
{
    public class SolverSkyline2 : ISolver
    {
        ...
        public SolverSkyline2(ILinearSystem linearSystem)
        {
        ...
        public void Solve()
        {
            ...
            double[] solution_data = new double[linearSystem.Solution.Length];
            linearSystem.Solution.CopyTo(solution_data, 0);  //WriteToFile(path);
            WriteToFileVector(solution_data, @"C:\Users\turbo-x\Desktop\notes_elegxoi\MSOLVE_output_2\U_linear_1.txt");
        }
