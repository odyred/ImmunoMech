...
namespace ISAAR.MSolve.Tests.FEM
{
    public class HyperElasticGrowthOxy
    {
        ...
        private static void RunTest()
        {
            ...
            var models = new[] { CreateOxygenTransportModel(DoxDays, conv0, new double[] { Dox[0]/Lwv*7e3*24*3600, Dox[1] / Lwv * 7e3 * 24 * 3600 }, c_oxNode).Item1, 
                CreateGrowthModel(0, new double[] { 0, 0, 0 }, 0, lgNode).Item1 };
            var modelReaders = new[] { CreateOxygenTransportModel(DoxDays, conv0, new double[] { Dox[0] / Lwv * 7e3 * 24 * 3600, Dox[1] / Lwv * 7e3 * 24 * 3600 }, c_oxNode).Item2, 
        ...
        {
            c_oxNode = solutions[0][0].CopyToArray();
