...
{
	public class tumModel_u_lg_c_ox_Tumc_p_Cs_SvD_Cv_a1_a2_
	{
		...
		private static Tuple<Model, IModelReader> oxModel, gModel, ctModel, prModel, csModel, 
			SvDModel, cvModel, a1Model, a2Model, structModel;
		...
		private static void RunTest()
		{
			...
			var models = new[] { SvDModel.Item1, oxModel.Item1, ctModel.Item1, gModel.Item1, 
				prModel.Item1, csModel.Item1, csModel.Item1, a1Model.Item1, a2Model.Item1 };
			var modelReaders = new[] { SvDModel.Item2, oxModel.Item2, ctModel.Item2, gModel.Item2, 
				prModel.Item2, csModel.Item2, cvModel.Item2, a1Model.Item2, a2Model.Item2 };
