...
{
	public class tumModel_u_lg_c_ox_Tumc_p_Cs_SvD_Cv_
	{
		...
		private static Tuple<Model, IModelReader> oxModel, gModel, ctModel, prModel, csModel, SvDModel, cvModel, structModel;
		...
		private static void RunTest()
		{
			...
			var models = new[] { SvDModel.Item1, oxModel.Item1, ctModel.Item1, gModel.Item1, prModel.Item1, csModel.Item1, csModel.Item1 };
			var modelReaders = new[] { SvDModel.Item2, oxModel.Item2, ctModel.Item2, gModel.Item2, prModel.Item2, csModel.Item2, cvModel.Item2 };
		...
		private static void CvCoefficientsCalculation(IList<IList<int>> elementIDsPerDomain, Dictionary<int, double> k, Dictionary<int, double[]> u, Dictionary<int, double> l)
		{
			foreach (IList<int> domain in elementIDsPerDomain)
			{
				...
				{
					k[id] = Dvegf[elementIDsPerDomain.IndexOf(domain)] * 24 * 3600;
				}
			}
			CvK = k;
			CvU = u;
