...
namespace ISAAR.MSolve.Tests.FEM
{
    public class ConvectionDiffusion1DBenchmark
    {
        ...
        private static Model CreateModel()
        {
            ...
            var material = new ConvectionDiffusionMaterial(k, U);
        ...
        private static IVectorView SolveModel(Model model)
        {
            ...
            var parentAnalyzer = new ConvectionDiffusionDynamicAnalyzer(model, solver, provider, childAnalyzer, 0.05, 5, initialTemp);
